...
const UPDATE_CASES: Array[Dictionary] = [
	...
	{"name": "primary rollback entry move", "boundary": "move_primary_to_rollback"},
	{"name": "primary rollback validation", "boundary": "validate_rollback", "phase": "read"},
	{"name": "vacated primary destination inspection", "boundary": "inspect_vacated_primary_destination", "phase": "exists"},
	...
	{"name": "rollback restore source inspection", "boundary": "inspect_rollback_restore_source", "phase": "exists", "corrupt_after": "commit_primary", "expect_uncertain": true},
	{"name": "rollback restore source validation", "boundary": "validate_rollback_restore_source", "phase": "read", "corrupt_after": "commit_primary", "expect_uncertain": true},
	{"name": "rollback restore destination inspection", "boundary": "inspect_rollback_restore_destination", "phase": "exists", "corrupt_after": "commit_primary", "expect_uncertain": true},
	{"name": "rollback directory entry restore", "boundary": "restore_primary_rollback_entry", "corrupt_after": "commit_primary", "expect_uncertain": true},
	{"name": "restored rollback primary validation", "boundary": "validate_restored_primary_rollback", "phase": "read", "corrupt_after": "commit_primary", "expect_uncertain": true},
	{"name": "backup fallback cleanup", "boundary": "restore_invalid_primary_from_backup_cleanup", "phase": "remove", "corrupt_after": "commit_primary", "fail_first": "restore_primary_rollback_entry", "fail_first_phase": "rename", "expect_uncertain": true, "seed_suffix": ".recover"},
	{"name": "backup fallback copy", "boundary": "restore_invalid_primary_from_backup_copy", "corrupt_after": "commit_primary", "fail_first": "restore_primary_rollback_entry", "fail_first_phase": "rename", "expect_uncertain": true},
	{"name": "backup fallback validation", "boundary": "validate_restore_invalid_primary_from_backup", "phase": "read", "corrupt_after": "commit_primary", "fail_first": "restore_primary_rollback_entry", "fail_first_phase": "rename", "expect_uncertain": true},
	{"name": "backup fallback destination status", "boundary": "restore_invalid_primary_from_backup_destination", "phase": "exists", "corrupt_after": "commit_primary", "fail_first": "restore_primary_rollback_entry", "fail_first_phase": "rename", "expect_uncertain": true},
	{"name": "backup fallback commit", "boundary": "restore_invalid_primary_from_backup_commit", "corrupt_after": "commit_primary", "fail_first": "restore_primary_rollback_entry", "fail_first_phase": "rename", "expect_uncertain": true},
